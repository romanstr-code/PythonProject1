...
class TestNegativeScenario:
    ...
    def teste_negative_login(self, driver, username, password, expected_error_message):
        # Go to Page
    ...
    def teste_negative_username(self, driver):
        # Go to Page
        driver.get("https://practicetestautomation.com/practice-test-login/")
    ...
    # Testing the Negative Scenario for Password
